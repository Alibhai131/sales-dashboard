    ...
    try {
        ...
        <body>
            <div class="no-print" style="margin-bottom: 20px; text-align: right;">
                <button onclick="window.print()" style="background:#7380ec; color:white; padding:10px 20px; border:none; border-radius:5px; font-weight:bold; cursor:pointer;">
                    🖨️ Print / Save as PDF
                </button>
            </div>
            ...
            <div class="footer">
                <p>Generated by SALES PRO Dashboard &copy; ${new Date().getFullYear()}</p>
            </div>
